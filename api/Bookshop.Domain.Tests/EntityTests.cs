    ...
    public class EntityTests
    {
        ...
        public class ShoppingCartTests
        {
            ...
            public void ShoppingCart_AddItem_ShouldAddNewItem()
            {
                ...
                var book = new Book("Test Book", "Description", "Publisher", "ISBN123", 20.0m, 50, 100, "5x8","URL", "NAME", Book.Languages.English, DateTime.Now, author, category);
        ...
        public class LineItemTests
        {
            ...
            public void LineItem_UpdatingQuantityBeyondAvailableStock_ShouldRecalculatePriceWithMaxBookQuantity()
            {
                ...
                var author = new Author("author1", "best author");
                var category = new Category("category1", "best category");
                var book = new Book("Test Book", "Description", "Publisher", "ISBN123", 10.0m, 2, 100, "5x8", "URL", "NAME", Book.Languages.English, DateTime.Now, author, category);
        ...
        public class OrderTests
        {
            ...
            public void Order_CalculateTotalOrder_ShouldReturnCorrectTotalAmount()
            {
                ...
                var author = new Author("author1", "best author");
                var category = new Category("category1", "best category");
                var book1 = new Book("Test Book 1", "Description", "Publisher", "ISBN123", 20.0m, 50, 100, "5x8", "URL", "NAME", Book.Languages.English, DateTime.Now, author, category);
                var book2 = new Book("Test Book 2", "Description", "Publisher", "ISBN456", 30.0m, 50, 150, "6x9", "URL", "NAME", Book.Languages.French, DateTime.Now, author, category);
